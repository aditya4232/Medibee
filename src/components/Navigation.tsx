...
import { Home, BarChart3, FileText, Brain, Menu, X } from 'lucide-react';
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 glass mx-4 mt-4 rounded-2xl">
      <div className="flex items-center justify-between max-w-7xl mx-auto p-4">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <Link
            to="/login"
            className="px-4 py-2 bg-medical-gradient text-white rounded-lg hover:opacity-90 transition-opacity"
          >
            Login
          </Link>
        </div>
        ...
        >
          <div className="space-y-2">
            ...
            <Link
              to="/login"
              onClick={() => setIsOpen(false)}
              className="flex items-center justify-center px-4 py-3 bg-medical-gradient text-white rounded-lg hover:opacity-90 transition-opacity"
            >
              Login
            </Link>
          </div>
